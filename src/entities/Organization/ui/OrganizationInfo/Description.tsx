...
export const Description = () => {
  return (
    <ScrollArea h={335} scrollbars='y' color={colors.gray} fz={16}>
      <p>
      ...
      <p>
        Razom was born out of the Revolution of Dignity in 2014 when millions of
        people worked together and risked their lives to build a pathway to a
        better future for Ukraine. Maidan successfully cleared the path for new
        leadership and reforms, and inspired countless citizens to get involved
        in the process. Soon after, in an effort to stifle and punish Ukraine’s
        progress, Russia invaded and annexed Crimea and began a war in Eastern
        Ukraine that it continues to fund and sustain today.
      </p>
      <p>
      ...
      Razom initiates short and long-term projects, or collaborates on existing
      projects with partner organizations, which help Ukraine stay on the path
      of fostering democracy and prosperity. We’ve grown a diverse community of
      volunteers and collaborators across the US and Ukraine which allows us to
      create spaces where people can meet, partner, and execute on these
      projects.
    </ScrollArea>
  );
};
